...
pub fn register(
    identifier: H256, sender: Address, vote_power: u64, dilithium_pubkey: Bytes,
    vrf_pubkey: Bytes, _bls_proof: [Bytes; 2], param: &ActionParams,
    ...
    hasher.update(dilithium_pubkey.as_slice());
