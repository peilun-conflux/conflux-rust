...
'''
conflux.config.default_config["GENESIS_STATE_ROOT"] = decode_hex("0x724d614b0ab70e875d50f39f583834a46f8b1092c59031a354180a77e273a2b7")
from conflux.utils import convert_to_nodeid, parse_as_int, encode_hex, privtoaddr
...
class SingleBench(ConfluxTestFramework):
    ...
    def run_test(self):
        ...
        if generate:
            ...
            #     tx = create_transaction(pri_key=genesis_key, receiver=privtoaddr(receiver_sk), value=value,
